...
TEST_F(SocketDriverFixture, connect_disconnect_tests)
{
   ...
   /**
    * <b>scenario</b>: Cannot set socket recv timeout.<br>
    * <b>expected</b>: Connection not started.<br>
    * ************************************************
    */
   EXPECT_CALL(*sys_call_mock, setsockopt(SOCK_FD, _, SO_RCVTIMEO, _, _)).WillOnce(Return(-1));
